...
// Adding request to request queue
    ...
    public void validateName(final VolleyCallback callback, String accountNumber,String name) throws JSONException {
        // Tag used to cancel the request
        String tag_json_obj = "json_obj_req";
        ...
        requestJSON.put("method","validateName");
